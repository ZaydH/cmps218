...
%  \maketitle
  ...
  \begin{itemize}[leftmargin=1.35cm]
    ...
    \item Noujan Pashanasangi -- We discussed second problem concerning the poisoned glass and in particular the third problem concerning soft K-Means stiffness.
